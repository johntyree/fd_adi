...
def forwardcoeffs(deltas, derivative=1, order=2, force_bandwidth=None):
    d = deltas
...
def centercoeffs(deltas, derivative=1, order=2, force_bandwidth=None):
...
def backwardcoeffs(deltas, derivative=1, order=2, force_bandwidth=None):
    d = deltas
...
def for_vector(vector, scheme="center", derivative=1, order=2,
